...
<div class="wrapper row0">
  <div id="topbar" class="hoc clear"> 
    ...
    <div class="fl_left">
      <ul class="nospace">
        <li><i class="fa fa-phone"></i> +8801682786501</li>
...
<div class="bgded overlay" style="background-image:url('images/2.jpg');"> 
  <!-- ################################################################################################ -->
        ...
        <ul class="clear">
          ...
          <li><a class="drop" href="#">Student</a>
            <ul>
              ...
              <li><a href="student/profileUpdate.php">Update Profile</a></li>
              <li><a href="student/result.php">Result</a></li>
              <li><a href="#">Live Result</a></li>
		  ...
		  <li><a class="drop" href="#">Courses</a>
            <ul>
              <li><a href="courses/registerCourses.php">Registerd Courses</a></li>
              <li><a href="courses/preReg.php">Pre-Registration</a></li>
    ...
    <article>
      ...
      <footer>
        <ul class="nospace inline pushright">
          ...
          <li><a class="btn inverse" href="comment/comment.php">Comment</a></li>
        </ul>
      </footer>
    </article>
    <!-- ################################################################################################ -->
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/02.png');">
  <article class="hoc container"> 
    ...
    <div class="group btmspace-30">
      <div class="fl_left" style="margin-right:20px;"><img src="images/demo/60x60.png" alt=""></div>
      <div class="fl_left">
        <p class="nospace font-xs">Ultrices pellentesque sed quis</p>
        <h3 class="heading">Rutrum nunc phasellus</h3>
      </div>
    </div>
    <blockquote>Sodales in at felis morbi et semper nibh vitae condimentum diam proin aliquam nisl quis laoreet finibus tellus risus tristique ligula vel efficitur mi leo sit amet arcu ut consequat tortor turpis elementum sodales mauris finibus sed curabitur justo tellus dignissim nec libero vel laoreet vulputate dolor in porta massa nisl quis condimentum eros sodales a cras ultricies.</blockquote>
    <em class="block btmspace-50 font-xs">Name / Title</em>
...
<div class="wrapper bgded overlay" style="background-image:url('images/demo/backgrounds/03.png');">
  <article class="hoc container center"> 
    <!-- ################################################################################################ -->
    <h3 class="font-x3">Sit consectetur adipiscing</h3>
    <p class="btmspace-50">Elit aliquam scelerisque consequat augue vitae pellentesque mauris dapibus nec</p>
...
<div class="wrapper row3">
  <section class="hoc container clear"> 
    ...
    <div class="three_quarter first">
      <h3 class="nospace">Velit sagittis magna hendrerit</h3>
      <p class="nospace">Sit amet facilisis mi faucibus proin imperdiet nunc sed ligula dapibus bibendum</p>
    </div>
  ...
  <div class="wrapper row4">
    <footer id="footer" class="hoc clear"> 
      ...
      <div class="one_quarter first">
        <h6 class="title">Consectetur adipiscing</h6>
        <p>Praesent non consequat mi vitae rhoncus tortor proin imperdiet euismod pretium maecenas ac neque malesuada mauris hendrerit cursus.</p>
        <p>Consequat leo eu ligula vulputate auctor cras gravida quis quam vel dignissim nullam lobortis justo ac congue.</p>
      </div>
      <div class="one_quarter">
        <h6 class="title">Duis suscipit tortor</h6>
      ...
      <div class="one_quarter">
        <h6 class="title">Non vestibulum rutrum</h6>
        <ul class="nospace linklist">
          <li><a href="#">Varius nullam a enim ac</a></li>
          <li><a href="#">Justo iaculis congue eu vel</a></li>
          <li><a href="#">Aliquam pulvinar fermentum</a></li>
          <li><a href="#">Lacus condimentum elementum</a></li>
          <li><a href="#">Vel nulla massa curabitur</a></li>
        </ul>
      </div>
      <div class="one_quarter">
        <h6 class="title">Imperdiet libero vitae</h6>
        <ul class="nospace linklist">
          <li>
            <article>
          ...
          <li>
            <article>
              <h6 class="nospace font-x1"><a href="#">Enim tempor neque</a></h6>
              <time class="font-xs block btmspace-10" datetime="2045-04-05">Thursday, 5<sup>th</sup> April 2045</time>
              <p class="nospace">Hendrerit justo cras in nulla a mi aliquet tempus integer&hellip;</p>
            </article>
          </li>
        </ul>
      </div>
