...
<body class="bg-dark">
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">Admin Login | GOLD AND DIAMONDS</div>
      <div class="card-body">
        <?php 
              if (isset($adminlogin)) {
            ?>
        ...
        <form action="" method="POST">
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputEmail1" type="email"  name="uname" aria-describedby="emailHelp" placeholder="Enter email">
          </div>
          <div class="form-group">
